...
export const IconCashMore = (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
    <path
      ...
      clipRule='evenodd'
    />
    <path d='M11 6a4 4 0 013.969 3.5c-.784.226-1.48.52-2.002.861A2 2 0 1012 11.732v2.142A4 4 0 1111 6z' />
    <path
      fillRule='evenodd'
...
export const IconLogin = (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
    <path
      fillRule='evenodd'
      d='M14.614 2.056a.823.823 0 00-.505.397c-.074.139-.089.231-.089.547 0 .331.013.403.1.558.11.197.294.34.515.401.089.025.982.041 2.308.041 2.475 0 2.448-.003 2.754.303.327.328.303-.294.303 7.698 0 5.906-.009 7.137-.055 7.289a1.02 1.02 0 01-.461.582l-.184.108-2.321.02-2.321.02-.199.102c-.34.175-.481.484-.45.982.03.464.244.752.639.858.103.028.963.038 2.544.029 2.376-.013 2.389-.013 2.668-.106a3.111 3.111 0 002.026-2.045l.094-.3V4.46l-.094-.3a3.084 3.084 0 00-2.025-2.038l-.321-.1-2.38-.009c-1.888-.008-2.414.001-2.546.043M9.626 6.045c-.206.109-.48.388-.588.599a.792.792 0 00.002.719c.06.12.639.729 1.813 1.907L12.578 11H7.695c-5.233 0-5.087-.005-5.373.199-.222.158-.302.369-.302.801 0 .331.013.403.1.558.11.197.294.34.515.401.094.026 1.885.041 5.044.041h4.899l-1.725 1.73C9.679 15.908 9.1 16.517 9.04 16.637c-.177.352-.088.717.259 1.064.347.347.711.436 1.064.259.123-.061.95-.857 2.698-2.594 1.387-1.378 2.573-2.54 2.635-2.582.154-.102.353-.545.353-.784 0-.256-.198-.679-.373-.799-.075-.051-1.261-1.213-2.636-2.583-1.661-1.654-2.557-2.518-2.668-2.574a.884.884 0 00-.746.001'
    />
  </svg>
);
...
export const IconLogout = (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
    <path
      fillRule='evenodd'
      d='M4.499 2.043a3.044 3.044 0 00-2.387 2.135L2.02 4.5v15l.092.322a3.08 3.08 0 002.066 2.066c.32.092.335.092 2.765.092h2.443l.195-.12c.241-.149.377-.394.408-.734.043-.472-.128-.849-.456-1.011l-.193-.095L7.02 20l-2.32-.02-.189-.111a1.038 1.038 0 01-.454-.539c-.079-.223-.079-14.437 0-14.66.079-.221.241-.414.454-.539L4.7 4.02 7.043 4l2.343-.02.195-.12c.247-.153.38-.397.408-.751.028-.344-.066-.664-.25-.847-.26-.26-.289-.263-2.796-.257-1.234.002-2.334.02-2.444.038m11.127 4.002a1.68 1.68 0 00-.583.59.864.864 0 00.001.737c.055.109.69.775 1.809 1.897l1.724 1.73-4.96.01-4.959.011-.199.102a.76.76 0 00-.319.297c-.112.181-.12.222-.12.578 0 .347.011.401.111.572a.862.862 0 00.3.3l.189.111 4.978.011 4.978.011-1.723 1.729c-1.119 1.122-1.754 1.788-1.809 1.897-.176.352-.085.733.255 1.073.34.34.721.431 1.073.255.111-.056 1.007-.92 2.668-2.574 1.375-1.37 2.558-2.53 2.629-2.578.182-.124.371-.533.371-.804s-.189-.68-.371-.804c-.071-.048-1.254-1.208-2.629-2.578-1.661-1.654-2.557-2.518-2.668-2.574a.884.884 0 00-.746.001'
    />
  </svg>
);
...
export const IconPackage = (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
    <path
      fillRule='evenodd'
      d='M11.555 2.346a1 1 0 01.89 0l7.314 3.657L17 7.382l-7.759-3.88 2.314-1.156zm-5.086.306L2.665 4.554l-.001.001A3 3 0 001 7.24V16.757a3 3 0 001.65 2.696l.003.001 8 4a3 3 0 002.684 0l7.998-3.998.001-.001A3 3 0 0023 16.771V7.24a3 3 0 00-1.664-2.685h-.001l-7.998-4-.447.895.445-.896a3 3 0 00-2.67 0l-.002.002-4.024 2.011c-.059.023-.116.052-.17.085zm.536 1.969L14.764 8.5 12 9.882l-7.759-3.88 2.764-1.381zm10.434 4.778L13 11.618v9.769l7.443-3.721.002-.002A1 1 0 0021 16.77V7.62l-3.543 1.77a1.2 1.2 0 01-.018.01zM3 7.618v9.149a1 1 0 00.55.9L11 21.392v-9.774l-8-4z'
      clipRule='evenodd'
    />
  </svg>
);
...
export const IconPhoneChecked = (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
    <path
      fillRule='evenodd'
      d='M22.722 2.692a1 1 0 10-1.444-1.384L17.21 5.554l-1.489-1.553a1 1 0 10-1.444 1.383l2.21 2.308a1 1 0 001.445 0l4.79-5zm-.696 19.447a3 3 0 00.972-2.223v-2.985a3 3 0 00-2.58-3.031 11.863 11.863 0 01-2.6-.647 2.999 2.999 0 00-3.163.676l-.721.721a15.002 15.002 0 01-4.586-4.586l.717-.717a3.002 3.002 0 00.68-3.169A11.834 11.834 0 0110.1 3.59 3.002 3.002 0 007.098 1h-2.99a3 3 0 00-2.986 3.27 20.804 20.804 0 003.227 9.124 20.49 20.49 0 006.303 6.3 20.778 20.778 0 009.058 3.22 3.009 3.009 0 002.316-.775zm-1.028-5.244v3.025a1.002 1.002 0 01-1.09 1.004 18.775 18.775 0 01-8.176-2.913 18.512 18.512 0 01-5.7-5.697 18.8 18.8 0 01-2.92-8.24A1 1 0 014.11 3h3c.51-.005.939.363 1.009.86.135 1.026.388 2.042.753 3.02a1 1 0 01-.224 1.057L7.381 9.203a1 1 0 00-.162 1.201 17 17 0 006.375 6.375 1 1 0 001.201-.162l1.27-1.27a.998.998 0 011.051-.22c.98.365 1.997.618 3.031.755.494.07.864.506.851 1.013z'
      clipRule='evenodd'
    />
  </svg>
);
...
export const IconRepeat = (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
    <path
      fillRule='evenodd'
      d='M17.707.293a1 1 0 10-1.414 1.414L18.586 4H7a5 5 0 00-5 5v2a1 1 0 102 0V9a3 3 0 013-3h11.586l-2.293 2.293a1 1 0 001.414 1.414l4-4A.996.996 0 0022 5L17.707.293zm0 0l4 4c.193.193.29.445.293.698L17.707.293zM22 15v-2a1 1 0 10-2 0v2a3 3 0 01-3 3H5.414l2.293-2.293a1 1 0 10-1.414-1.414l-4 4a.998.998 0 000 1.414l4 4a1 1 0 001.414-1.414L5.414 20H17a5 5 0 005-5z'
      clipRule='evenodd'
    />
  </svg>
);
...
export const IconUpload = (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'>
    <path
      fillRule='evenodd'
      d='M9.293.293a1 1 0 011.414 0l5 5a1 1 0 01-1.414 1.414L11 3.414v9.657c0 .513-.448.929-1 .929s-1-.416-1-.929V3.414L5.707 6.707a1 1 0 01-1.414-1.414l5-5zM1 12a1 1 0 011 1v4a1 1 0 001 1h14a1 1 0 001-1v-4a1 1 0 112 0v4a3 3 0 01-3 3H3a3 3 0 01-3-3v-4a1 1 0 011-1z'
      clipRule='evenodd'
    />
  </svg>
);
