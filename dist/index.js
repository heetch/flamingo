...
var Icon = styled__default('i').attrs(function (_ref2) {
  var icon = _ref2.icon;
  return {
    className: 'f-Icon',
    children: SVGS[icon]
...
var Content = styled__default.span(_templateObject$2(), function (_ref7) {
...
var SpinnerContainer = styled__default('div')(_templateObject2$1());
var Button = styled__default(function (_ref9) {
...
var UiText = styled__default('p').attrs(function (_ref4) {
...
var Helper = styled__default(UiText).attrs(function () {
  return {
    as: 'small',
...
var Heading = styled__default(UiText).attrs(function (_ref2) {
  var as = _ref2.as,
      level = _ref2.level;
  return {
...
var IconButton = styled__default(IconButtonComponent)(_templateObject$7(), Icon);
...
var FormElementWrapper = styled__default('div').attrs(function () {
  return {
...
var FormElement = styled__default('div').attrs(function () {
  return {
    className: 'f-FormEl'
  };
...
var Overlay = styled__default('div').attrs(function () {
  return {
    className: 'f-Overlay'
  };
...
var StyledSidePanel = styled__default('div')(_templateObject$b(), function (_ref) {
  var isOpen = _ref.isOpen;
  return isOpen ? 'inherit' : 'none';
}, function (_ref2) {
  var isOpen = _ref2.isOpen;
...
var Content$1 = styled__default('div')(_templateObject2$2());
var Header = styled__default('div')(_templateObject3$1());
var Footer = styled__default('div')(_templateObject4(), Button, Button);
...
var Text = styled__default(UiText).attrs(function () {
  return {
    className: 'f-Text'
  };
